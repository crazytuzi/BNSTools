...
{
    public partial class Insertdq : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Epoch = Epoch_str.Substring(0, Epoch_str.IndexOf("</Epoch>"));
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Acction = TextBox1.Text.Trim();
                string dq = TextBox2.Text.Trim();
